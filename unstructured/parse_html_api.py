...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--file-path", required=True, help="Path to the directory containing the files."
    )
    parser.add_argument(
        "--api-url", default="http://localhost:8000/general/v0/general", help="API URL."
    )
    parser.add_argument("--file_type", default="pdf", help="File type to send.")
    parser.add_argument(
        "--coordinates",
        default=False,
        help="Whether to include coordinates or not.",
        action="store_true",
    )
